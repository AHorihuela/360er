...
SET 
    ...
    updated_at = GREATEST(feedback_requests.updated_at, ru.new_created_at)
FROM request_updates ru
WHERE feedback_requests.id = ru.request_id;

-- Update feedback_responses (without updated_at)
UPDATE feedback_responses
SET 
    created_at = fr.created_at,
    submitted_at = GREATEST(feedback_responses.submitted_at, fr.created_at)
FROM feedback_requests fr
...
SET 
    created_at = fr.created_at,
    updated_at = GREATEST(ai_reports.updated_at, fr.created_at)
FROM feedback_requests fr
