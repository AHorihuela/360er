/*
 * Database Maintenance: Final Cleanup of Renamed Tables
 * =========================================================
 * 
 * Date: June 2024
 * Purpose: Permanently remove tables that were renamed in step 1
 * 
 * This script should only be run after:
 * 1. Running 1_rename_before_cleanup.sql
 * 2. Testing the application thoroughly for at least a week
 * 3. Confirming no functionality is broken
 * 
 * Tables affected:
